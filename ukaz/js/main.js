...
$(document).ready(function () {
    ...
    $('.js-btn-popup').click(function (e) {
        e.preventDefault();
        let index_btn_popup = $(this).attr('data-id-popup');
    ...
    $('.obl-item').hover(
        function () {
            $(this).css({ fill: '#ffcda0', stroke: '#ffcda0', });

        },

        function () {
            $(this).css({ fill: '#ffffff', stroke: '#888888', });
        },
    );
    ...
    $('.js-items-obl').hover(
        ...
        function () {
            let dateAttr = $(this).attr('data-ob');

            $('.obl-item').each(function () {
                if (dateAttr.indexOf($(this).attr('data-id-popup')) != -1) {
                    $(this).css({ fill: '#ffcda0', stroke: '#ffcda0', });
                }
            });
        },
